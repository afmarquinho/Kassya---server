...
CREATE TABLE "User" (
    ...
    "User_registrationDate" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Customer" (
    ...
    "Customer_registrationDate" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Supplier" (
    ...
    "Supplier_registrationDate" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Purchase" (
    ...
    "Purchase_totalAmount" DECIMAL(65,30) NOT NULL,
